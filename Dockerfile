...
RUN Rscript -e 'remotes::install_version("leafgl", upgrade="never", version = "0.2.2")'
RUN Rscript -e 'remotes::install_version("golem", upgrade="never", version = "0.5.1")'
RUN Rscript -e 'remotes::install_version("ckanr", upgrade="never", version = "0.7.0")'
...
#RUN Rscript -e 'remotes::install_version("ggbreak", upgrade="never", version = "0.1.2")'
